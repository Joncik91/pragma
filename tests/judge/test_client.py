...
class TestEnvVarPassthrough:
    def _run_capturing_client_args(
        ...
        def capturing_judge_test(prod: str, test: str, lang: str) -> tuple[bool, str] | None:
    ...
    def test_base_url_env_var_passed_to_constructor(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("PRAGMA_LLM_API_KEY", "test-key")
